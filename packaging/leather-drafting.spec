...
a = Analysis(
    ...
    datas=[
        ...
        (os.path.join(ROOT, "leathercad_app", "resources", "fonts",
                      "DejaVuSans.ttf"), "leathercad_app/resources/fonts"),
        (os.path.join(ROOT, "leathercad_app", "resources", "fonts",
                      "DejaVuSans-Bold.ttf"), "leathercad_app/resources/fonts"),
        (os.path.join(ROOT, "leathercad_app", "resources", "fonts",
                      "LICENSE-DejaVu.txt"), "leathercad_app/resources/fonts"),
    ],
    hiddenimports=[],
    hookspath=[],
    hooksconfig={},
